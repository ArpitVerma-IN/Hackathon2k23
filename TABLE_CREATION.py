...
def table_creation_MED_INFO():
    ...
    cursor=mycon.cursor()
    mycon.autocommit=True
    s3="create table IF NOT EXISTS MED_INFO(MD_ID int(6),DISEASES varchar(100), ALLERGIES varchar(100), GENETIC_INFO varchar(100),SURGICAL_HISTORY varchar(100),OTHER varchar(100))"
    cursor.execute(s3)
